titanic<-read.csv('C:/Alisha/UTD MS BUAN/Spring 2018/MIS 6380-0W1 - Data Visualization/Exercises/7/kmean/titanic.csv')
dim(titanic)
...
write.csv(titanic, file = "titanicNew_AlishaPaul_1.csv")
titanic<-read.csv("titanicNew_AlishaPaul_1.csv")
...
plot(btwss,xlab = "Number of Cluster",type="b",ylab="Total Betweem Sum of Square")
